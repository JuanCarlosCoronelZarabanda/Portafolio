...
function App() {
  ...
  return (
    <main className='bg-[#09080e]  text-[#ffffff]' >
      ...
      <div className='grid grid-cols-2 items-start bg-[#0a0816]' id="home">
        <div className='px-[20px] w-full grid md:grid-cols-2 gap-1 pt-[200px]  pr-[60%]'>
          ...
          <div className='w-[300px] md:pl-[100px] lg:pl-40 h-[70%]'>
          ...
          <h1 className='text-3xl  text-[#08dcf8] font-bold flex justify-stretch'><IconHeartCode size={40} />I Can:</h1>
        </div>
