        ...
        <div className='w-80 aspect-square md:hover:w-[400px] hover:gap-0  border-[#0c08f8] border-[3px]'>
          <a href="https://entregable2-blue.vercel.app/" target="_blank" className=" ">
            ...
            <p className=" ">
              <span>
                WEATHER APP.
                In this practice I learned: useEffect and consumo de API’s
        ...
        <div className='w-80 aspect-square md:hover:w-[400px] hover:gap-0 pt-0  border-[#0c08f8] border-[3px]'>
          ...
          <img src="https://entregable3-phi.vercel.app/img2.png" alt="" className="h-[300px]"/>
            ...
            <p className=" ">
              <span>
                RICK AND MORTY.
                In this practice I learned: Listas and Keys, inputs controlados, renderizado condicional. This is a site where the user can see information about the locations of the “Rick and Morty” universe.
              </span>
            </p>
          </a>
          <div className="flex place-items-stretch">
